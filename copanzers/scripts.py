...
class RadarInterface:
    ...
    def destroyed(self):
        return Destroyed in self.eman.database and self.e in self.eman.database[
            Destroyed]
...
class ROInterface(RadarInterface):
    ...
    def mounts(self):
        ...
        return [
            ROInterface(m, self.eman) if m else None
...
class RWInterface(ROInterface):
    ...
    def max_speed(self):
        ...
        """
        return self.eman.component_for_entity(self.e, Movement).max_speed
    ...
    def mounts(self):
        ...
        """
        return [
            RWInterface(m, self.eman) if m else None
            for m in self.eman.component_for_entity(self.e, Mount).mounts]
    ...
    def visible(self):
        ...
        """
        return (
            i for i in self.eman.component_for_entity(self.e, Vision).visible
            if not i.destroyed)
